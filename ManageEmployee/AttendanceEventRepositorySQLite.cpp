...
bool AttendanceEventRepositorySQLite::add(AttendanceEventModel attendanceEvent) {
...
bool AttendanceEventRepositorySQLite::update(AttendanceEventModel attendanceEvent) {
...
bool AttendanceEventRepositorySQLite::_delete(int id) {
...
bool AttendanceEventRepositorySQLite::_deleteByEmployeeId(QString employeeId) {
...
QList<AttendanceEventModel> AttendanceEventRepositorySQLite::getAll() {
...
AttendanceEventModel AttendanceEventRepositorySQLite::getById(int id) {
    return AttendanceEventModel();
}

QList<AttendanceEventModel> AttendanceEventRepositorySQLite::getByEmployeeId(QString employeeId) {
...
QList<AttendanceEventModel> AttendanceEventRepositorySQLite::getBySession(int session) {
...
AttendanceEventModel AttendanceEventRepositorySQLite::getByDateAndTimeAndEmployeeId(QString date, QString time, QString employeeId) {
...
bool AttendanceEventRepositorySQLite::deleteBySession(int session) {
