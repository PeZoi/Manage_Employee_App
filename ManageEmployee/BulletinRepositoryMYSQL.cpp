#include "BulletinRepositoryMYSQL.h"
#include "Constant.h"
#include <QSqlQuery>
#include <QSqlError>

BulletinRepositoryMYSQL::BulletinRepositoryMYSQL(IDatabaseManager* _db) {
	db = _db;
}

bool BulletinRepositoryMYSQL::add(BulletinModel bulletin) {
...
bool BulletinRepositoryMYSQL::update(BulletinModel bulletin) {
...
bool BulletinRepositoryMYSQL::_delete(int id) {
...
QList<BulletinModel> BulletinRepositoryMYSQL::getAll() {
...
BulletinModel BulletinRepositoryMYSQL::getById(int id) {
	BulletinModel bulletin;
...
bool BulletinRepositoryMYSQL::updateActived(int id, bool checked) {
