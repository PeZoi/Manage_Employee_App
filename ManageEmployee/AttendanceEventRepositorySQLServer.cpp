...
AttendanceEventRepositorySQLServer::AttendanceEventRepositorySQLServer(IDatabaseManager* _db) {
    db = _db;
}

bool AttendanceEventRepositorySQLServer::add(AttendanceEventModel attendanceEvent) {
...
bool AttendanceEventRepositorySQLServer::update(AttendanceEventModel attendanceEvent) {
...
bool AttendanceEventRepositorySQLServer::_delete(int id) {
...
bool AttendanceEventRepositorySQLServer::_deleteByEmployeeId(QString employeeId) {
...
QList<AttendanceEventModel> AttendanceEventRepositorySQLServer::getAll() {
...
AttendanceEventModel AttendanceEventRepositorySQLServer::getById(int id) {
    return AttendanceEventModel();
}

QList<AttendanceEventModel> AttendanceEventRepositorySQLServer::getByEmployeeId(QString employeeId) {
...
QList<AttendanceEventModel> AttendanceEventRepositorySQLServer::getBySession(int session) {
...
AttendanceEventModel AttendanceEventRepositorySQLServer::getByDateAndTimeAndEmployeeId(QString date, QString time, QString employeeId) {
...
bool AttendanceEventRepositorySQLServer::deleteBySession(int session) {
