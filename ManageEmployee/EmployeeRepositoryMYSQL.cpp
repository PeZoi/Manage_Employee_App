...
EmployeeRepositoryMYSQL::EmployeeRepositoryMYSQL(IDatabaseManager* _db) {
	db = _db;
}

bool EmployeeRepositoryMYSQL::add(EmployeeModel employee) {
...
bool EmployeeRepositoryMYSQL::update(EmployeeModel employee) {
...
bool EmployeeRepositoryMYSQL::toggleEnabled(QString id, bool checked) {
	db->connectToDatabase();
...
bool EmployeeRepositoryMYSQL::changeAvatar(QString path, QString id) {
...
bool EmployeeRepositoryMYSQL::signInAdmin(QString pass) {
...
bool EmployeeRepositoryMYSQL::checkStatusIn(QString id) {
...
bool EmployeeRepositoryMYSQL::updateStatus(QString status, QString id) {
...
bool EmployeeRepositoryMYSQL::checkExistAdmin() {
